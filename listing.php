<?php
$page_title = 'Freelance jobs | Meetfreelancers 
';
$seo_title = 'Freelance jobs | Meetfreelancers 
';
$seo_description = "Meetfreelancers.com helps you to Find Jobs Easily by selecting your country and freelance service that you experience in.";
...
if ($incomplete_profile == 1 && basename($_SERVER["SCRIPT_FILENAME"], '.php') != 'make-profile') {
    ?> style="margin-top: 10px;" <?php } ?>>	
     <?php
     if ($filter_res[title] != "") {
         echo '<h3 align="center" style="font-size:16px">' . $filter_res[title] . '</h3>';
     } else {
         echo '&nbsp';
     }
     ?>
