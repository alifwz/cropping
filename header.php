...
if(isset($page_title) && $page_title != ''){}else{$page_title = 'Freelancer';}
if(isset($seo_title) && $seo_title != ''){}else{$seo_title = '';}
if(isset($seo_description) && $seo_description != ''){}else{$seo_description = '';}
if(isset($seo_keywords) && $seo_keywords != ''){}else{$seo_keywords = '';}
?>
                    ...
                    <div class="sub-header">
                        ...
                        if ($loginid != "") {
                            if ($incomplete_profile == 1) {
                                ?>
                                <a href="javascript:void(0);" class="bell-div incompleteprofile">
                                <?php } else {
                                    ?>
                                    ...
                                    ?>
                                <?php } else { ?>
                                    <a data-type="invitation.php" href="javascript:void(0);" class="bell-div loginpopup">
                                    <?php } ?>
