                ...
                <div class="menu-main-sub">
                    ...
                    <div class="menu-links">
                        <ul>
                            ...
                            <li><a href="index.php?qanda=1"><span class="menu-icon"><img src="images/qanda.png" alt="About Us" /></span> Q and A</a></li>
                            ...
                            <?php if ($loginid != "") { ?>
                                ...
                                <?php if ($incomplete_profile) { ?>
                                    <li><a href="javascript:void(0);" class="border_post incompleteprofile"><span class="menu-icon"><img src="images/icon-feedback.png" alt="Feedback / Report" /></span> Feedback / Report</a></li>
                                    <li><a href="javascript:void(0);" class="border_post incompleteprofile"><span class="menu-icon"><img src="images/icon-verified.png" alt="Verified User" /></span> Verified User</a></li>
                                <?php } else { ?>
                            ...
                            <?php } else { ?>
                                <li><a data-type="make-profile.php" href="javascript:void(0);" class="border_post loginpopup"><span class="menu-icon"><img src="images/icon-upload-profile.png" alt="Profile" /></span> Edit Profile </a></li>
    ...
    <div class="bottom-holder">
                    ...
                    <div class="container clearfix">
                        <div class="register-container">
                            <div class="footer-logo">
                                <img src="images/f-logo.jpg" width="180" />
                            </div>
                        </div>
                        <div class="login-container">
                            ...
                            if ($loginid == "") {
                                if (isset($redirect) && $redirect == 1) {
                                    ?>
                                    <div><a data-type="listing.php?t=1569875525" href="javascript:void(0);" class="hire-link login-link loginpopup">Login</a></div>
                                <?php } else { ?>
                                    <div><a href="#" data-fancybox data-type="inline" data-src="#loginPopup" class="hire-link login-link">Login</a></div>
                                <?php } ?>
                                <div class="already-a-member"><a href="register.php" class="work-link_b register-link_b">Register</a></div>
                                <?php
                            } else {
                                ?>
                                <div class="already-a-member"><a href="logout.php?id=<?php echo $loginid ?>" class="work-link_b register-link_b">Logout</a></div>
                            <?php }
                            ?>
                        </div>
                    </div>
        ...
        <div class="sub-bottom-bar">
            ...
            <form name="upload" id="imageform" action='ajaximage.php' method="post" enctype="multipart/form-data">
                <div class="photo-job-video">
                    <div class="row post-job-title">
                        Post a
                    </div>
                    <div class="row" style="margin-bottom: 0px;">
                        <?php if ($loginid == "") { ?>
                            <div class="col-3 uploader"><a style="font-size:20px" data-type="postanimage.php" href="javascript:void(0);" class="border_post loginpopup">photo</a></div>
                                <div class="col-2"><a style="font-size:20px" data-type="post-a-job.php" href="javascript:void(0);" class="border_post loginpopup">job</a></div>
                                <div class="col-3 uploader"><a style="font-size:20px" data-type="postvideo" href="javascript:void(0);" class="border_post loginpopup">Video</a></div>
                                <div class="col-4 uploader"><a style="font-size:20px" data-type="post-a-que.php" href="javascript:void(0);" class="loginpopup">Question</a></div>
                                <?php
                            } else {
                                $notcomplete = 0;
                                ...
                                <div class="col-3 uploader"><a style="font-size:20px"
                                    <?php if ($notcomplete == 1) { ?>
                                                                   data-fancybox data-type="inline" data-src="#profilefillPopup" href="javascript:void(0);"
                                                               <?php } else {
                                                                   ?>
                                                                   href="postanimage.php"
                                                               <?php } ?> class="border_post">photo</a><div class="fileContainer"></div>				
                                </div>
                                <div class="col-2"><a style="font-size:20px" <?php if ($notcomplete == 1) { ?>
                                                          data-fancybox data-type="inline" data-src="#profilefillPopup" href="javascript:void(0);"
                                                      <?php } else {
                                                          ?> href="post-a-job.php" <?php } ?> class="border_post">job</a></div>
                                <div class="col-3 uploader"><a style="font-size:20px" <?php if ($notcomplete == 1) { ?>
                                                                   data-fancybox data-type="inline" data-src="#profilefillPopup" href="javascript:void(0);"
                                                               <?php } else {
                                                                   ?> href="javascript:void(0);" data-options='{"closeClickOutside":false,"touch": false}' data-fancybox data-type="inline" data-src="#videoPopup" <?php } ?> class="border_post">Video</a><div class="fileContainer"></div>
                                </div>
                                <div class="col-4 uploader"><a style="font-size:20px"
                                                               <?php if ($notcomplete == 1) { ?> data-fancybox data-type="inline" data-src="#profilefillPopup" href="javascript:void(0);" <?php } else { ?> href="post-a-que.php" <?php } ?>>Question</a><div class="fileContainer"></div>				
                                </div>
                            <?php } ?>
                        </div>
                    </div>
                ...
                <div class="work-hire-main">
                    <div class="container clearfix">
                        ...
                        if ($_SESSION[SESS_SUBCAT_ID] != "") {
                            $id = $_SESSION[SESS_SUBCAT_ID];
                            ?>
                            <a href="listing.php?cid=<?php echo $id ?>&t=<?php echo time(); ?>" class="work-link">WORK</a>
                        <?php } else { ?>
                            <a href="listing.php?t=<?php echo time(); ?>" class="work-link">WORK</a>
                        <?php } ?>
                        <?php if ($incomplete_profile == 1) { ?>
                            <a data-type="index.php" href="javascript:void(0);" class="plus-link incompleteprofile">+</a>
                        <?php } else { ?>
        ...
        <div class="popbox">
            <div id="loginPopup" class="popupbox text-align-center">
                <div class="login-main">
                    <span class="account_activated">Account activated, Please login to continue.</span>
                        ...
                        <div class="for gotpass-main">
                            ...
                            <div class="form-group">
                                <select style="
                                        font-size: 15px;
                                        height: 40px;
                                        "  name="category" id="post-photo-category-select" required class="form-control inputbg">
...
<a data-fancybox="" data-type="inline" data-src="#incompleteprofile" href="javascript:void(0);" class="incompleteprofilepop none"></a>
<div class="popbox">
    <div id="incompleteprofile" class="popupbox text-align-center abuseOption" style="background:white;">
        <div class="form-group">
            <p style="color:#e11e26; font-weight:bold;">Complete your profile to start</p>
        </div>
        <div class="form-group">
            <div class="row login-register">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <a href="make-profile.php" class="button">Complete Profile</a>
                </div>
            </div>
        </div>
    </div>
...
//    });
//
//    $('#post-video-category').on("change", function () {
//        var categoryId = $(this).find('option:selected').val();
//        if (categoryId == '') {
//            $("#post-video-subcategory").html('');
//        } else {
//            $.ajax({
//                url: "subcatajax.php",
//                type: "POST",
...
//                    $("#post-video-subcategory").html(response);
//                },
//            });
//        }
//    });
...
<script>
<?php // if ($incomplete_profile == 0) {  ?>
    $('.plus-link').click(function () {
        $('.photo-job-video-form').show()
...
<script type="text/javascript">
    ...
    $(document).on("change", '#post-photo-category-select', function () {
        var categoryId = $(this).find('option:selected').val();
        if (categoryId == '') {
    ...
    $(document).on('click', '.incompleteprofile', function () {
        $('.incompleteprofilepop').trigger('click');
    })
