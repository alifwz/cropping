...
if ($incomplete_profile == 1 && basename($_SERVER["SCRIPT_FILENAME"], '.php') != 'make-profile') {
    ...
    <section class="contenets-main">
        <?php
        if ($pid != "") {
            $about_que = mysql_query("SELECT * from freelancer_mmv_userimages"
                    . " join freelancer_mmv_member_master on freelancer_mmv_member_master.member_id = freelancer_mmv_userimages.userid"
                    . " where freelancer_mmv_userimages.id='$pid' AND freelancer_mmv_userimages.status=1"
                    . " AND freelancer_mmv_userimages.userid!='' "
                    . " AND freelancer_mmv_member_master.status=1 ORDER BY id DESC");
                            ...
                            <tr>
                                ...
                                if ($loginid != '') {
                                    ...
                                    <td class="likes-div" style="cursor:pointer">
                                        <a data-type="index.php?like=<?php echo $about_res[id]; ?>" href="javascript:void(0);" class="loginpopup"><i class="fa">&#xf08a;</i> <?php echo $count; ?> likes</a></td>
                                <?php } ?>
                            </tr>
                        </table>
                    </div>
        ...
        <div id="postList">
            ...
            if (!isset($_GET['qanda']) || $_GET['qanda'] == 0) {
                ...
                if ($_SESSION[countryid] == "" && $id == "" && $filterid == '') {
                    $about_que1 = mysql_query("SELECT freelancer_mmv_userimages.*,'photos' as 'type',`date` AS created from freelancer_mmv_userimages"
                            . " join freelancer_mmv_member_master on freelancer_mmv_member_master.member_id = freelancer_mmv_userimages.userid"
                            . " where freelancer_mmv_userimages.userid!='' AND freelancer_mmv_userimages.status=1 "
                            . " AND freelancer_mmv_member_master.status=1"
                            . " ORDER BY id DESC LIMIT 10");
                } else if ($_SESSION[countryid] == "" && $id != "" && $filterid == '') {
                    $about_que1 = mysql_query("SELECT freelancer_mmv_userimages.*,'photos' as 'type',`date` AS created from freelancer_mmv_userimages"
                            . " join freelancer_mmv_member_master on freelancer_mmv_member_master.member_id = freelancer_mmv_userimages.userid"
                            . " where freelancer_mmv_userimages.userid!='' AND freelancer_mmv_userimages.status=1"
                            . " AND freelancer_mmv_member_master.status=1 AND freelanceserviceid=$id ORDER BY id DESC LIMIT 10");
                } else if ($_SESSION[countryid] != "" && $id == "" && $filterid == '') {
                    $about_que1 = mysql_query("SELECT freelancer_mmv_userimages.*,'photos' as 'type',`date` AS created from freelancer_mmv_userimages"
                            . " join freelancer_mmv_member_master on freelancer_mmv_member_master.member_id = freelancer_mmv_userimages.userid"
                            . " where freelancer_mmv_userimages.userid!='' AND freelancer_mmv_userimages.status=1"
                            . " AND freelancer_mmv_member_master.status=1 AND freelancer_mmv_userimages.countryid='$countryid' ORDER BY id DESC LIMIT 10");
                } else if ($_SESSION[countryid] == "" && $filterid != '') {
                    $about_que1 = mysql_query("SELECT freelancer_mmv_userimages.*,'photos' as 'type',`date` AS created from freelancer_mmv_userimages where "
                            . " join freelancer_mmv_member_master on freelancer_mmv_member_master.member_id = freelancer_mmv_userimages.userid"
                            . " freelancer_mmv_userimages.userid!='' AND freelancer_mmv_userimages.status=1"
                            . " AND freelancer_mmv_member_master.status=1 $filterid ORDER BY id DESC LIMIT 10");
                } else if ($_SESSION[countryid] != "" && $filterid != '') {
                    $about_que1 = mysql_query("SELECT freelancer_mmv_userimages.*,'photos' as 'type',`date` AS created from freelancer_mmv_userimages"
                            . " join freelancer_mmv_member_master on freelancer_mmv_member_master.member_id = freelancer_mmv_userimages.userid"
                            . " where freelancer_mmv_userimages.userid!='' AND freelancer_mmv_userimages.status=1"
                            . " AND freelancer_mmv_member_master.status=1"
                            . " $filterid AND countryid='$countryid' ORDER BY id DESC LIMIT 10");
                } else {
                    $about_que1 = mysql_query("SELECT freelancer_mmv_userimages.*,'photos' as 'type',`date` AS created from freelancer_mmv_userimages"
                            . " join freelancer_mmv_member_master on freelancer_mmv_member_master.member_id = freelancer_mmv_userimages.userid"
                            . " where freelancer_mmv_userimages.userid!='' AND freelancer_mmv_userimages.status=1"
                            . " AND freelancer_mmv_member_master.status=1"
                            . " AND freelancer_mmv_userimages.freelanceserviceid=$id AND countryid='$countryid' ORDER BY id DESC LIMIT 10");
                }
                ...
                if ($imgcount == 0) {
					...
					<div class="topbar">
						<div class="container">
							<p align="center" style="font-size:18px">No resultsssss!!</p>
						</div>
					</div>
				 </div>';
                } else {
            ...
            if (count($all_contents) > 0) {
                foreach ($all_contents as $about_res1) {
                    if ($about_res1['type'] == 'photos') {
                        ...
                        $mycount = mysql_num_rows($userlikcount);
                        ?>
                        <div class="contenets post_<?php echo $idd; ?>">
                            <div class="topbar">
                                <div class="container clearfix">
                                    <?php
...
//                                    
                                    ...
                                    <table width="100%">
                                        <tr>
                                            ...
                                            if ($loginid != '') {
                                                ...
                                                <?php } else { ?>
                                                    <td class="likes-div" style="cursor:pointer"><i class="fa" style="color: #ed4956;">&#xf004;</i><a href="likers.php?ccid=<?php echo $idd; ?>"> <?php echo $count; ?> likes</a></td>
                                                    <?php
                                                }
                                            } else {
                                                ?>
                                                <td class="likes-div" style="cursor:pointer">
                                                    <a  data-type="index.php?like=<?php echo $about_res1[id] ?>" href="javascript:void(0);" class="loginpopup"><i class="fa">&#xf08a;</i> <?php echo $count; ?> likes</a></td>
                                            <?php } ?>
                                        </tr>
                                    </table>
                                </div>
                        ...
                        $ans_que = mysql_query("SELECT ans.answers_id,ans.answer,users.member_id,users.first_name,users.last_name,users.image FROM `freelancer_mmv_answers` as ans 
                                                ...
                                                WHERE ans.`questions_id` = $questions_id AND ans.`status` = 1 and users.status = 1");
                        $ans_count = 0;
                        $all_ans = [];
                        ...
                        $userlikcount = mysql_query("SELECT * from freelancer_mmv_que_ans_likes where questions_id='$questions_id' AND liked_by='$loginid'");
                        $mycount = mysql_num_rows($userlikcount);
                        ?>
                        <div class="contenets que_<?php echo $questions_id; ?>">
                            <div class="topbar">
                                <div class="container clearfix">
                                    ...
                                    <div class="clearfix">
                                        <form  method="post" action="" class="mb-2 mt-2" enctype="multipart/form-data">
                                            ...
                                            <div class="input-group_">
                                                <textarea class="form-control ans_input" style="border:0px solid #979797;height: 42px;" name="answer" placeholder="Please answer the question here" autocomplete="off"></textarea>
                                ...
                                <div class="container clearfix mt-2">
                                    ...
                                    <div class="row clearfix mb-2 border-box" style="    border-bottom: 1px solid #ddd;
    border-top: 1px solid #ddd;">
                                        ...
                                        <div class="col-4 text-right pl-0">
                                            ...
                                            if ($mycount > 0 ) {
                                                ?>
                                                <span class="likes-div" style="cursor:pointer"><i id="likeQue_<?php echo $questions_id; ?>" data-touser="<?php echo $userinfo['member_id']; ?>" class="fa" style="color: #ed4956;">&#xf004;</i> <a href="likers.php?queid=<?php echo $questions_id; ?>"><span id="qlikes<?php echo $questions_id; ?>"><?php echo $count; ?></span> likes</a></span>
                                            <?php }else if ($loginid != '') {
                                                ?>
                                            ...
                                            <?php } else {
                                                ?>
                                                <span class="likes-div" style="cursor:pointer">
                                                    <a data-type="index.php?likeque=<?php echo $questions_id . '_' . $userinfo['member_id']; ?>" href="javascript:void(0);" class="loginpopup"><i class="fa">&#xf08a;</i> <?php echo $count; ?> likes</a></span>
                                            <?php } ?>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            if (count($all_ans) > 0) {
                                                foreach ($all_ans as $anss) {
                                                    ...
                                                    $userlikcount = mysql_query("SELECT * from freelancer_mmv_que_ans_likes where answers_id='$answers_id' AND liked_by='$loginid'");
                                                    $mycount = mysql_num_rows($userlikcount);
                                                    ?>
                                                    <div class="clearfix mb-2" style="border-bottom: 1px solid #ddd;">
                                                        ...
                                                        <div class="text-right">
                                                            ...
                                                            if ($mycount>0) {
                                                                ?>
                                                                <span class="likes-div" style="cursor:pointer"><i id="likeAns_<?php echo $answers_id; ?>" data-touser="<?php echo $anss['member_id']; ?>" class="fa" style="color: #ed4956;">&#xf004;</i> <a href="likers.php?ansid=<?php echo $answers_id; ?>"><span id="alikes<?php echo $answers_id; ?>"><?php echo $count; ?></span> likes</a></span>
                                                            <?php }else if ($loginid != '') {
                                                                ?>
                                                            ...
                                                            <?php } else {
                                                                ?>
                                                                <span class="likes-div" style="cursor:pointer">
                                                                    <a data-type="index.php?likeans=<?php echo $answers_id . '_' . $anss['member_id']; ?>" href="javascript:void(0);" class="loginpopup"><i class="fa">&#xf08a;</i> <?php echo $count; ?> likes</a></span>
                                                            <?php } ?>
                                                        </div>
                                                    </div>
                                                    <?php
...
<script>
    $(function () {
        ...
        function likescript(i) {
            var OLDlikes = $('#this' + i).text();
            $.ajax({
                type: "POST",
                data: "id=" + i,
                url: "likescript.php",
                success: function (data)
                {
                    ...
                    if(parseInt(OLDlikes)<parseInt(data) ){
                          $('#delete_' + i).css('color','#ed4956').html('&#xf004;');
                    }else{
                        $('#delete_' + i).css('color','#000').html('&#xf08a;');
                    }
                }
            });
        }

<?php if (isset($_GET['like']) && $_GET['like'] != '') { ?>
            var i = '<?php echo $_GET['like']; ?>'
            likescript(i);
            var $container = $("html,body");
            var $scrollTo = $('.post_'+i);
...
<?php } ?>
        ...
        function likeque(i, touser) {
            var OLDlikes = $('#qlikes' + i).text();
            $.ajax({
                type: "POST",
                data: "queid=" + i + "&touser=" + touser,
                ...
                success: function (data)
                {
                    ...
                    if(parseInt(OLDlikes)<parseInt(data) ){
                          $('#likeQue_' + i).css('color','#ed4956').html('&#xf004;');
                    }else{
                        $('#likeQue_' + i).css('color','#000').html('&#xf08a;');
                    }
                }
            });
        }
<?php if (isset($_GET['likeque']) && $_GET['likeque'] != '') { ?>
            var i = '<?php echo $_GET['likeque']; ?>'
            var arr = i.split("_");
            var i = arr[0];
            var touser = arr[1];
            likeque(i, touser);
...
<?php } ?>
        $("[id^='likeQue_']").click(function () {
            ...
            var arr = i.split("_");
            var i = arr[1];
            var touser = $(this).attr('data-touser');
            likeque(i, touser)
        });

        function likeans(i, touser) {
            var OLDlikes = $('#alikes' + i).text();
            $.ajax({
                type: "POST",
                data: "ansid=" + i + "&touser=" + touser,
                url: "likescript_que.php",
                success: function (data)
                {
                    if (data != "")
                    ...
                    if(parseInt(OLDlikes)<parseInt(data) ){
                          $('#likeAns_' + i).css('color','#ed4956').html('&#xf004;');
                    }else{
                        $('#likeAns_' + i).css('color','#000').html('&#xf08a;');
                    }
                }
            });
        }
<?php if (isset($_GET['likeans']) && $_GET['likeans'] != '') { ?>
            var i = '<?php echo $_GET['likeans']; ?>'
            var arr = i.split("_");
            var i = arr[0];
            var touser = arr[1];
            likeans(i, touser)
